...
export function UpcomingPredictionNudge({
  ...
  return (
    <div className="relative mx-auto max-w-7xl overflow-hidden border border-accent/16 bg-gradient-to-r from-accent-muted/55 via-surface to-surface shadow-sm">
      {onDismiss && (
        <button
          type="button"
