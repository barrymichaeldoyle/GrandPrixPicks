...
const SHOW_ADMIN_TESTING_SCENARIOS =
  import.meta.env.DEV &&
  import.meta.env.VITE_ENABLE_ADMIN_TESTING_SCENARIOS === 'true';

const AdminScenarioPanel = SHOW_ADMIN_TESTING_SCENARIOS
  ? lazy(() =>
      import('./AdminScenarioPanel').then((module) => ({
        default: module.AdminScenarioPanel,
      })),
    )
  : null;
