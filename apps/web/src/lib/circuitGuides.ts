...
const CIRCUIT_GUIDES: Record<string, CircuitGuide> = {
  ...
  madring: {
    ...
    layout:
      'The 837-metre run down Ribera del Sena and several heavy stops reward straight-line speed and braking stability, while the Valdebebas sequence, taken flat out through Turns 14 to 16, asks for high-speed balance. Turn 12, La Monumental, is the signature: a 550-metre corner banked at 24 percent, taken at speed and followed by heavy braking for Turn 13.',
    racing:
